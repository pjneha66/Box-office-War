...
function viewStudio(){
  ...
  if(G.ach && Object.keys(G.ach).length){
    h+="<div class='section-title'>🏆 Achievements ("+Object.keys(G.ach).length+")</div><div class='card'><div class='row'>"+
       Object.keys(G.ach).map(k=>"<span class='tag gold'>🏆 "+k+"</span>").join("")+"</div></div>";
  }
